<template>
    <svg width="100%" viewBox="0 0 675 675" fill="var(--dgreen3)" xmlns="http://www.w3.org/2000/svg"
        class="mandala animate__animated animate__fadeIn">
        <title>Mandala</title>
        <defs>
            ...
            <path d="M337.5,337.5 m-160,0 a160,160 0 1,1 320,0 a160,160 0 1,1 -320,0" id="text"></path>
        </defs>
